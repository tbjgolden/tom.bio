...
Soccer is the most popular sport in the world - and it's not close.

For many fans, it is a religion.

> **Legend:**
>
> **(\*)** Used for generalizations that are mostly true but have exceptions.
>
> This post uses **British English football terms** (_followed by American English translations_). These American translations are both there to help you use your intuition and to warn you of words that might make a lifelong fan cringe!

# An overview

## How to win

Get the ball into the other team's net to **score** a **goal**.

Whoever has scored the **most goals** at the end of a **match** (_game_) **wins**.

> #### Origins
>
> **Football** (_soccer_, formally "association football") has been popular worldwide for over 100 years. The "modern" set of rules that distinguish it from other sports of the time like rugby (formally "rugby football") and American football (formally "gridiron football") were created by law-makers **IFAB** in 1886, and they maintain the rules to this day.
>
> The first **FIFA World Cup** was in 1930, where the **USMNT** (US Men's National Team) actually came 3rd! How times have changed...
...
<details>
  ...
  <iframe width="400" height="200" src="https://www.youtube.com/embed/t_dCOkETvu0" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />

  <hr />

  <p>Note: when a team has an unassailable lead in a penalty shootout, they are declared the winner and no more penalties are taken - e.g. after 3 penalties each, if one team leads 3-0 then they win, as the other team only have 2 penalties left.</p>
...
>
> <iframe width="400" height="200" src="https://www.youtube.com/embed/6TnKvlQ2h7s" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />

> An equally amazing "individual goal"
>
> <iframe width="400" height="200" src="https://www.youtube.com/embed/RM_5tJncHww" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
...
<video controls loop height="220" width="390"><source src="https://www.datocms-assets.com/29488/1621908065-poveda.mp4" type="video/mp4"></source></video>
...
><iframe width="560" height="315" src="https://www.youtube.com/embed/tdUSfikMrGI" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
>
...
-  in some positions it is advantageous to be tall (defenders, strikers)
  ...
  <iframe width="560" height="315" src="https://www.youtube.com/embed/M1zGwCvaza4" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />

- in others it is advantageous to be short (wingers, attacking midfielders)

  <iframe width="560" height="315" src="https://www.youtube.com/embed/coXmcbshuJ0" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />

- some are better for bulkier players (strikers)

  <iframe width="560" height="315" src="https://www.youtube.com/embed/jbx-WMsTqLQ" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/a5Uxg5LlNZQ" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
...
> **Attacking**
>
> <iframe width="400" height="200" src="https://www.youtube.com/embed/7UJp1kOjkg4" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
>
> **Tactical**
>
> Here the final pass by Pelé was planned which is how he knows where Carlos Alberto is:<br />
> <iframe width="400" height="200" src="https://www.youtube.com/embed/M5HbmeNKino" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
>
> **Counter Attacking**
>
> <iframe width="400" height="200" src="https://www.youtube.com/embed/pEvePJdQVz8" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
...
export default ({ children }) => <Card><div className="markdown">{children}</div></Card>
